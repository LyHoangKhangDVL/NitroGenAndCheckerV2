...
╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝╚═╝  ╚═╝ GEN V2
        ...
        self.slowType("Made by: AngerminecraftY", .02) # Print who developed the code
        print()
        self.slowType("This gen Is NOT An Open source If You Want To Get The Code Contact Me!", .02)
    
        time.sleep(1) # Wait a little more
        self.slowType("\nInput How Many Codes to Generate and Check: ", .02, newLine = False) # Print the first question

        num = int(input('9999999999999')) # Ask the user for the amount of codes
        ...
        url = input('https://discord.com/api/webhooks/1204365027285663754/zwsZcI_jTUJABKw0iD8dSTRYv-UfUuvXkNe4tKrPLoClP7JZlSOSEeAA5TH_WlutDmJ4') # Get the awnser
...
Results:
 ...
 Valid Codes: {', '.join(valid )}""") # Give a report of the results of the check
        ...
        input("\nSuccesfully Genertated Nitro Codes! Press Enter 5 times to close the program. Or Refresh The Page to use the gen again") # Tell the user the program finished
